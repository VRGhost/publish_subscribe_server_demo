...
def get_arg_parser():
    ...
    parser.add_argument("--db", help="File to the database to use for message persistence.", default="./publish_subscribe.db")
    return parser
...
def main(args):
    ...
    print "Starting the Publish/Subscribe server at the port {} (using database {!r})".format(args.port, args.db)
